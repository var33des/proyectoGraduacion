...
<div class="container-fluid">
    <form class="d-flex">
        <input class="form-control me-2 light-table-filter" data-table="table_id" type="search"
               placeholder="Buscar proveedor" style="color: #1F37BD">
        <hr style="margin-top: 30px;">
    </form>
    <br>
</div>
<div class="table-container">
    <form method="POST" id="deleteForm" action="borrar_proveedor.php">
        <table class="table table-striped table-dark table_id">
            ...
            if ($dato->num_rows > 0) {
                while ($fetch = mysqli_fetch_assoc($dato)) {
                    ?>
                    <tr>
                        <td><input type="checkbox" name="check[]" value="<?php echo $fetch['idProveedor']; ?>"></td>
                        <td><a class="link" href="modifyproviders.php?c=<?php echo $fetch['idProveedor']; ?>"><?php echo $fetch['idProveedor']; ?></a></td>
                        <td><?php echo $fetch['nombre']; ?></td>
                        <td><?php echo $fetch['contacto']; ?></td>
                        <td><?php echo $fetch['telefono']; ?></td>
                        <td><?php echo $fetch['direccion']; ?></td>
                        <td><a href="modifyproviders.php?c=<?php echo $fetch['idProveedor']; ?>">Editar</a></td>
                    </tr>
                    <?php
                }
            } else {
    ...
    <a href="agregar/addprov.php" id="btn">
...
<section id="popAlert">
    <aside>
        ...
        <p>¿Está seguro de que desea eliminar los proveedores seleccionados?</p>
