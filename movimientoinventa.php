...
<div class="container-fluid">
    <form class="d-flex">
        <input class="form-control me-2 light-table-filter" data-table="table_id" type="search"
               placeholder="Buscar movimiento" style="color: #1F37BD">
        <hr style="margin-top: 30px;">
    </form>
    <br>
</div>
<div class="table-container">
    <form method="POST" id="deleteForm" action="borrar_movimiento.php">
        <table class="table table-striped table-dark table_id">
            ...
            if ($dato->num_rows > 0) {
                while ($fetch = mysqli_fetch_assoc($dato)) {
                    ?>
                    <tr>
                        <td><input type="checkbox" name="check[]" value="<?php echo $fetch['idMovimiento']; ?>"></td>
                        <td><a class="link" href="modifymov.php?c=<?php echo $fetch['idMovimiento']; ?>"><?php echo $fetch['idMovimiento']; ?></a></td>
                        <td><?php echo $fetch['idMovimiento']; ?></td>
                        <td><?php echo $fetch['idProducto']; ?></td>
                        <td><?php echo $fetch['idUsuario']; ?></td>
